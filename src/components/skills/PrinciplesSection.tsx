        ...
        <div className="grid w-full grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {cards.map((card) => (
            <motion.div
              ...
              className={`flex flex-col items-start rounded-2xl bg-white px-7 py-9 ${CASE_STUDY_SHADOW_SM} ${CASE_STUDY_SHADOW_SM_HOVER}`}
            >
              <span className="text-2xl leading-10 text-zinc-600">{card.icon}</span>
