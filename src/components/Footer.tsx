...
export default function Footer() {
  return (
    <div className="relative mt-[140px] h-32 w-full border-t border-white/5 bg-bg-inverse">
      <div className="absolute top-[41px] left-[100px] inline-flex flex-col items-start justify-start">
      ...
      <a
        ...
        className="absolute top-[51px] right-[100px] flex size-8 items-center justify-center rounded-md bg-white"
      >
